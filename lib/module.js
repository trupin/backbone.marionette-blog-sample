...
/**
 * Implements the search feature of a module.
 * @param __
 * @param {function} callback
 */
exports.Module.prototype.search = function (__, callback) {
    callback(new _errors.NotFound('This module doesn\'t implements the search feature. Sorry!'));
};
    ...
    _.each(Module.prototype, function (fn, route) {
        if (route.toString().indexOf('$') === 0) {
            var method = fn.method || 'get',
                ...
                EntityIn = fn.EntityIn,
                EntityOut = fn.EntityOut;
